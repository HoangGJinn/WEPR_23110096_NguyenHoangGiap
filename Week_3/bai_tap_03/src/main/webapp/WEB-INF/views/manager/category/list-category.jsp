...
<head>
    ...
    <title>Danh sách Category của tôi</title>
        ...
        <div class="card">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="bi bi-grid"></i> Danh sách Category của tôi</h4>
                    <a href="<c:url value='/manager/category/add'/>" class="btn btn-light">
                            ...
                            <c:if test="${empty cateList}">
                                <tr>
                                    <td colspan="4" class="text-center text-muted">
                                        <i class="bi bi-inbox"></i> Bạn chưa có category nào
                                    </td>
                                </tr>
                            </c:if>
                        </tbody>
            ...
            <div class="card-footer text-muted">
                <a href="<c:url value='/manager/home'/>" class="btn btn-outline-secondary">
