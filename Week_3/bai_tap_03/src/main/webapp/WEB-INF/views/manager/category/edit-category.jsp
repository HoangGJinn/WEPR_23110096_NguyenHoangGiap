    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <h4 class="mb-0"><i class="bi bi-pencil-square"></i> Chỉnh sửa danh mục</h4>
            </div>
            <div class="card-body">
                ...
                <form role="form" action="<c:url value='/manager/category/edit'/>" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label class="form-label">
                            <i class="bi bi-image"></i> Ảnh đại diện hiện tại
                        </label>
                        <c:if test="${not empty cate.icon}">
                            <div class="current-image">
                                <c:url value="/image?fname=${cate.icon}" var="imgUrl"></c:url>
                                <img src="${imgUrl}" class="img-fluid rounded" style="max-height: 200px;" alt="${cate.catename}">
                            </div>
                        </c:if>
                        <c:if test="${empty cate.icon}">
                            <div class="alert alert-info">
                                <i class="bi bi-info-circle"></i> Chưa có ảnh
                            </div>
                        </c:if>
                    </div>
                    ...
                    <div class="mb-4">
                        <label class="form-label">
                            <i class="bi bi-upload"></i> Chọn ảnh mới (nếu muốn thay đổi)
                        </label>
                        <input type="file" 
                               class="form-control" 
                               name="icon" 
                    ...
                    <div class="mb-4" id="newImagePreviewContainer" style="display: none;">
                        <label class="form-label">
                            <i class="bi bi-eye"></i> Xem trước ảnh mới
                        </label>
                        <div class="preview-box" id="newImagePreview"></div>
                    </div>
